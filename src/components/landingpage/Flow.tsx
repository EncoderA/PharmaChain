...
const Flow = () => {
  return (
    <div>
      ...
      <div className="min-h-[50rem] w-full relative">
        <div
          className="h-full w-full absolute inset-0 z-0 bg-background flex items-center justify-center"
          style={{
            backgroundImage: `
                  radial-gradient(circle at 25% 25%, light-dark(#e5e5e5, #222222) 0.5px, transparent 1px),
                  radial-gradient(circle at 75% 75%, light-dark(#d4d4d4, #111111) 0.5px, transparent 1px)
                `,
        ...
        <div className="p-8 pt-10">
          <div className=" max-w-4xl ">
            <div className="flex items-center mb-2 gap-2">
              ...
              <h1 className="text-xl md:text-xl font-normal">
                SecurePharma Chain
              </h1>
            </div>
            <p className="text-lg md:text-base text-foreground font-medium">
              Preventing drug counterfeiting through blockchain-powered supply
              chain verification and real-time authentication.
            </p>
          </div>
        </div>
        <SvgAnimation />
      </div>
      <div className="max-w-6xl  mx-auto  absolute bottom-12 left-16 mb-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className=" space-y-4">
            <h3 className="text-xl font-semibold text-foreground flex items-center gap-2">
              <Verified />
              Instant Drug Verification
            </h3>
            <p className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed">
              A simple QR scan interface to instantly verify drug authenticity,
              and validate supply chain integrity.
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed">
              Blockchain nodes synchronize continuously to track drug movement
              in real-time.
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed">
              Custom smart contracts automatically enforce FDA regulations.
            </p>
          </div>
        </div>
      </div>
