...
import { Search, Filter, Plus, Download, Eye, CheckCircle, AlertCircle } from "lucide-react";
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          ...
          <p className="text-muted-foreground mt-2">
            Manage and verify all pharmaceutical products registered on the blockchain
          </p>
        </div>
                ...
                {filteredProducts.map((product) => {
                  ...
                  return (
                    <tr key={product.id} className="border-b border-border hover:bg-muted/20">
                      ...
                      <td className="px-4 py-3 text-sm">{product.manufacturer}</td>
                      <td className="px-4 py-3 text-sm font-mono">{product.batch}</td>
                      <td className="px-4 py-3">
